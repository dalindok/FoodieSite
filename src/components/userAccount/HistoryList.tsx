...
const HistoryList = () => {
  ...
  return (
    <div className="grid grid-rows-1 gap-6 mt-10 md:w-2/3 w-fit mx-auto font-zain md:pl-20 md:pr-20 pl-3 pr-3 pt-5">
        ...
        >
          ...
          <div className="flex flex-col ml-1 space-y-2 m-auto">
            ...
            <div className="text-base">
              ...
              <p>
                Table No: <span className="font-medium">{restaurant.tableNo}</span>
              </p>
              <p className="pl-20">
